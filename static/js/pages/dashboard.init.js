...
var options, chart, linechartBasicColors = getChartColorsArray("stacked-column-chart"),
    radialbarColors = (linechartBasicColors && (options = {
        chart: {
            height: 360,
            type: "bar",
            stacked: !0,
        ...
        fill: {opacity: 1}
    }, (chart = new ApexCharts(document.querySelector("#stacked-column-chart"), options)).render()), getChartColorsArray("radialBar-chart"));
